            ...
            <div class="max-w-2xl">
                ...
                <div class="text-center">
                    ...
                    <div class="flex items-center justify-center gap-6">
                        @auth
                        <a href="{{ route('questions.create') }}" class="px-4 py-2 rounded bg-indigo-600 text-white hover:bg-indigo-700">
                            Preguntar
                        </a>
                        @else
                        <a href="{{ route('login') }}" class="px-4 py-2 rounded bg-indigo-600 text-white hover:bg-indigo-700">
                            Preguntar
                        </a>
                        @endauth
